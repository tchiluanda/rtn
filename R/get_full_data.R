...
get_full_data <- function(){
  ...
  series_temporais_analise_rec<-tidyr::gather(rtn_receita,Data, Valor,-Rubrica)
  ...
  series_temporais_analise_desp<-tidyr::gather(rtn_despesa,Data, Valor,-Rubrica)
  ...
  series_temporais_analise_IPCA<-tidyr::gather(deflator_IPCA,Data, Valor,-Rubrica)
